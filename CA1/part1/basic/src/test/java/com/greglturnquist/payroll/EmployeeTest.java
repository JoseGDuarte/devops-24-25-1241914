...
class EmployeeTest {
    ...
    void testValidEmployee() {
        Employee employee = new Employee("John", "Doe", "A dedicated employee", 5);
    ...
    void testFirstNameNull() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee(null, "Doe", "A dedicated employee", 5);
        });
    ...
    void testFirstNameBlank() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("", "Doe", "A dedicated employee", 5);
        });
        assertEquals("First name must be a non-empty string.", exception.getMessage());
    }
    ...
    void testFirstNameInvalidChars() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("john", "Doe", "A dedicated employee", 5);
        });
    ...
    void testFirstNameLength() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("J", "Doe", "A dedicated employee", 5);
        });
    ...
    void testLastNameNull() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("John", null, "A dedicated employee", 5);
        });
    ...
    void testLastNameBlank() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("John", "", "A dedicated employee", 5);
        });
        assertEquals("Last name must be a non-empty string.", exception.getMessage());
    }
    ...
    void testLastNameLength() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("John", "D", "A dedicated employee", 5);
        });
    ...
    void testJobYearsNegative() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("John", "Doe", "A dedicated employee", -1);
        });
    ...
    void testJobYearsExceedsMax() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new Employee("John", "Doe", "A dedicated employee", 51);
        });
    ...
    void testJobYearsValid() {
        Employee employee = new Employee("John", "Doe", "A dedicated employee", 25);
        assertNotNull(employee);
